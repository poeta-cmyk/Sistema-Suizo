...
if st.session_state.registro_abierto:
    ...
    if st.session_state.asistentes:
        # LISTA E INFO (LO QUE TE ENCANTA)
    ...
    with t2:
        ...
        st.table([{"Pos": i+1, "Atleta": j, "G": st.session_state.juegos_ganados.get(j,0), "Ef": st.session_state.efectividad.get(j,0), "P. Contra": st.session_state.puntos_contra.get(j,0)} for i, j in enumerate(rk)])
